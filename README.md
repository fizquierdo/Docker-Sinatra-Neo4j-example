[![Build Status](https://travis-ci.org/fizquierdo/Docker-Sinatra-Neo4j-example.svg?branch=master)](https://travis-ci.org/fizquierdo/Docker-Sinatra-Neo4j-example)
